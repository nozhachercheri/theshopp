...
Route::group(['prefix' => 'v1', 'as' => 'api.'], function () {
    ...
    Route::group(['prefix' => 'auth'], function () {
        ...
        Route::group(['middleware' => 'auth:api'], function () {
            ...
            Route::get('upload/{id}',[AuthController::class,'getimage']);
        });
    });
    ...
    Route::get('brandbyid/{id}', [BrandController::class,'showById']);
    ...
    Route::group(['prefix' => 'product'], function () {
        ...
        Route::get('ddddd', [ProductController::class,'getAttributeValue']);
    });
    ...
    Route::group(['middleware' => 'auth:api'], function () {
        ...
        Route::group(['prefix' => 'user'], function () {
            ...
            Route::get('orderUser', [OrderController::class,'FindOrderByUser']);
            Route::get('orderP/{poduct_id}', [OrderController::class,'FindProductByOrder']);
            ...
            Route::get('wishlistsid',[WishlistController::class,'showbyid']);
            ...
            Route::get('followid', [FollowController::class,'showFollowById']);
            ...
            Route::post('wallet/recharge', [WalletController::class,'wallet_payment_done']);
    ...
    Route::post('shop/nameshop', [ShopController::class,'show_by_name']);
    Route::get('shop/{id}', [ShopController::class,'show_by_id']);
    Route::get('shopAll/{id}', [ShopController::class,'showAll_by_id']);
    Route::get('all-shops', [ShopController::class,'index']);
    Route::get('all-shopsById', [ShopController::class,'indexAllId']);
    
    Route::get('shop123/{slug}', [ShopController::class,'show']);
    ...
    Route::post('shops/{slug}/productss', [ShopController::class,'shop_products']);
    Route::get('shop/{slug}/brands', [ShopController::class,'showbybrand']);
});
