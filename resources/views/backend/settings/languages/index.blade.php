                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('languages.save_default_language') }}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <select class="form-control aiz-selectpicker" name="DEFAULT_LANGUAGE" data-live-search="true" data-selected="{{ env('DEFAULT_LANGUAGE') }}">
...
@section('script')
    <script type="text/javascript">
        function update_status(el){
            ...
            $.post('{{ route('languages.update_status') }}', {_token:'{{ csrf_token() }}', id:el.value, status:status}, function(data){
                if(data == 1){
                    setTimeout(() => {
                        location.reload();
                    }, 300);
