...
<link rel="apple-touch-icon" href="{{ static_asset('web-assets/img/icons/icon-512x512.png') }}">
...
<meta name="msapplication-TileImage" content="{{ static_asset('web-assets/img/icons/icon-512x512.png') }}">
